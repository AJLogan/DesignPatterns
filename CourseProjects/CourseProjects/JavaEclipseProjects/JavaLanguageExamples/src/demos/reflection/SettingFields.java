...
public class SettingFields extends JFrame {
	public static void main(String[] args) throws Exception {
		SettingFields gui = new SettingFields();
		gui.pack();
		gui.setVisible(true);
	}
	public SettingFields() throws Exception {
		super();
	...
	private void reflect() throws Exception {
		Class<? extends SettingFields> klass = getClass();
