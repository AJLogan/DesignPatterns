package demos.security.bytecode;
...
public class ClassFileReader {
	public static void main(String[] args) throws Exception {
		...
		reader.read("demos"+sep+"security"+sep+"bytecode"+sep+"Test.class");
	}
	private ClassFileReader() {
		super();
	}
	private void read(String fname) throws Exception {
		ClassLoader cl = ClassFileReader.class.getClassLoader();
		dis = new DataInputStream(cl.getResourceAsStream(fname));
