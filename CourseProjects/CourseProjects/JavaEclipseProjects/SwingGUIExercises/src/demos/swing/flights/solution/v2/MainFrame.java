...
public class MainFrame extends JFrame implements ActionListener {
	public MainFrame() {
		...
		resultsTableModel = new FlightsTableModel();
		...
		list1.add("Luton");
		ListModel model1 = new FlightsListModel(list1);
		ListModel model2 = new FlightsListModel(list1);
		originSelection = new JList(model1);
		destinationSelection = new JList(model2);
