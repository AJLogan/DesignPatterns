...
namespace CourseBookingMobileCS.DataAccess {
    public class StubTrainingCourseDAO : ITrainingCourseDAO {
        ...
        private readonly List<TrainingCourse> additions;
        private readonly List<TrainingCourse> updates;
    }
}