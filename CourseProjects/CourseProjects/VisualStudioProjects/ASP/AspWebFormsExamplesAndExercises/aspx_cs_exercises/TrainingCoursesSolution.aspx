<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrainingCoursesSolution.aspx.cs" Inherits="TrainingCoursesSolution" %>
...
<body>
    <form id="form1" runat="server">
        <asp:ObjectDataSource ID="myObjectDataSource"
                              TypeName="AspxExercises.TrainingV1.TrainingCourse"
                              DataObjectTypeName="AspxExercises.TrainingV1.Delegate"
