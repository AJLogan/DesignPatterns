<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TrainingCoursesTwoSolution.aspx.vb" Inherits="TrainingCoursesTwoSolution" %>
...
<body>
    <form id="form1" runat="server">
       <asp:ObjectDataSource ID="myObjectDataSource"
                              TypeName="TrainingV2.TrainingCourse"
                              DataObjectTypeName="TrainingV2.TrainingDelegate"
