...
<script runat="server">
	protected Sub Page_Load(obj as Object, args as EventArgs)
	...
	End Sub
	private shared function buildStandardExamples() as ArrayList
		Dim examples as ArrayList= new ArrayList()
	...
	private Shared Function buildControlsExamples() as ArrayList
    ...
    private shared function buildDataBindingExamples() as ArrayList
        Dim controls As ArrayList = New ArrayList()
