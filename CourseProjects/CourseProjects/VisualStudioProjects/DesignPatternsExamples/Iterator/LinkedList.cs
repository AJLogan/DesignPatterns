...
namespace Iterator {
    public class LinkedList<T> : IEnumerable<T> {
        private class LinkedListEnumerator<E> : IEnumerator<E> {
            internal LinkedListEnumerator(Node<E> node) {
                first = node;
            }
        ...
        public override string ToString() {
            if (IsEmpty()) {
                ...
                var sb = new StringBuilder("List Contents:");
                Node<T> current = first;
                while (current != null) {
                    sb.Append(" ");
